...
<html>
<head>
  <title>Shibboleth Integrated iRODS Browser</title>
  ...
  <script type="text/javascript" src="js/RODSShibWindow.js"></script>
  <script type="text/javascript" src="js/RODSShibInfoWindow.js"></script>
...
<body id="body">  
  ...
  <div id="file-win" class="x-hidden">
    <div id="tabs" class="x-hidden">        
        <div id= "fileviewer-tab-perm-grid"></div>     
        <div id= "fileviewer-tab-meta-grid"></div>
        <div id= "fileviewer-tab-repl-grid"></div>
    </div>
  </div>
