...
Ext.extend(RODS.AppMgr, Ext.Container, {  
  ...
  showFile : function(ruri, callerwin) {
    ...
    // use Java applet to download the file
    //Helper_Applet.copy('download', 'ignoreMe', "null", [ruri]);        
    ...
    switch (file_ext) {
      ...
      default:
        // use Java applet to download the file
        Helper_Applet.copy('download', 'ignoreMe', [ruri]);        
    	  break;
    }
    */
  },
  ...
  showImage : function(ruri, callerwin)
  {
    ...
    /*
    var img_url='http://ubuntu/irods2/rodsproxy/'+ruri; //TODO: fix this next
    var img=new Image();
    img.src=img_url;
